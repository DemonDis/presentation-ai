...
export const mediaEmbedItems: MediaEmbedItem[] = [
  {
    ...
    description: "Встраивание YouTube видео",
  },
  {
    key: "vimeo",
    label: "Vimeo",
    ...
    description: "Встраивание Vimeo видео",
  },
  {
    key: "loom",
    label: "Loom",
    ...
    description: "Встраивание Loom записей",
  },
  {
    key: "twitter",
    label: "Twitter",
    ...
    description: "Встраивание постов Twitter",
  },
  {
    key: "figma",
    label: "Figma",
    ...
    description: "Встраивание Figma макетов",
  },
  {
    key: "maps",
    label: "Google Maps",
    ...
    description: "Встраивание Google Maps",
  },
  {
    key: "codepen",
    label: "CodePen",
    ...
    description: "Встраивание CodePen демо",
  },
  {
    key: "image",
    label: "Изображение",
    ...
    description: "Вставка изображения по URL",
  },
  {
    key: "infographic",
    label: "Инфографика",
    ...
    description: "Создание AI инфографики",
  },
  {
    key: "website",
    label: "Сайт",
    ...
    description: "Встраивание ссылки на сайт",
  },
];
  ...
  (config, item) => {
    ...
    if (embedConfig) {
      config[item.embedType] = {
        ...
        placeholder: `Введите URL ${item.label}...`,
